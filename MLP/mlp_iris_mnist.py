...
class MLP:
        ...
        while iters < max_iter:
            ...
            for p in range(N):
                ...
                for i in range(1, self.l):
                    ...
                    prev_d = d_layer
            plot_iter.append(iters)
            plot_error.append(100 - (correct/N)*100)
        plt.plot(plot_iter, plot_error, color = 'red')
    ...
    def testMLP(self, Xtest, Ytest):
        ...
        print('Confusion Matrix(Actual values are on the top, and Predicted values are on the left side)')
        print()
        conf_matrix = confusion_matrix(y_true, y_pred)
        print('         Positive| \t Negative|')
        print('Positive| ', conf_matrix[0][0], '\t \t \t', conf_matrix[0][1])
        print('Negative| ', conf_matrix[1][0], '\t \t \t', conf_matrix[1][1])
        print()
        print("---------------------------------------------------------------")
